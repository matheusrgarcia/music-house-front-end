...
@Component({
  ...
  styleUrls: ['./external-profiles.component.css']
})
...
respostas:any;
  ...
  ngOnInit() {
    ...
    this.restApi.getFriendInfo(this.amigoId).subscribe(posts => {
      this.respostas = posts;

      console.log("respostas: ",this.respostas, "Amigo ID:", this.amigoId);
    });
  }
